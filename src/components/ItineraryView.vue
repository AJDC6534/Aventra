<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else-if="itinerary" class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div class="flex-1">
            ...
            <div class="flex flex-wrap items-center gap-6 text-sm text-gray-600">
              <div class="flex items-center gap-2">
                ...
                <span>Budget: <span class="font-medium">${{ itinerary.budget || 'Not set' }}</span></span>
              </div>
              <div v-if="itinerary.preferences?.interests?.length" class="flex items-center gap-2">
              ...
              <div v-if="itinerary.preferences?.pace" class="flex items-center gap-2">
          ...
          <div class="p-8">
            <div v-if="day.activities && day.activities.length > 0" class="space-y-6">
              <div 
                ...
                :class="{ 'bg-gray-50 border-gray-300': editMode }"
              >
                <!-- View Mode -->
                ...
                <div v-else class="space-y-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        type="time"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-150"
                      >
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-150 resize-none"
                    ></textarea>
                  </div>
                  ...
                  <div class="flex justify-end pt-2">
                    <button 
                      ...
                      class="inline-flex items-center gap-1 text-red-600 hover:text-red-700 text-sm font-medium transition-colors duration-150"
                    >
                      <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div v-else class="text-center py-16">
              ...
              <p class="text-gray-600 mb-6">Add some activities to make the most of your time!</p>
              <button 
                v-if="editMode"
                @click="addActivity(dayIndex)"
                class="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-150"
              >
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
      ...
      <!-- Save Changes Section (Edit Mode) -->
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              @click="saveItinerary"
              :disabled="saving"
              class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
            >
            ...
            <button 
              @click="cancelChanges"
              class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-150"
            >
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
